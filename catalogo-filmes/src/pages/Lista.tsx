...
function Lista() {
    ...
    useEffect(() => {
        const filmesImpares = filmesData.filter((filme) => filme.id % 2 != 0);
        setFilmes(filmesImpares);
    }, []);
    ...
    return (
        <>
            ...
            <div className='bg-[#525252] px-15 py-10 text-white'>
                <div className="bg-[#525252] px-15 py-10 text-white">
                    <h1 className="font-bold lg:text-7xl md:text-5xl text-4xl mb-10">Minha lista + </h1>
