            ...
            <div className="bg-[#030D18] text-[#B01212] py-10 px-15 flex flex-col items-center gap-5">
                ...
                <div className="flex flex-col justify-center items-center text-center lg:text-start lg:items-start md:text-start md:items-start">
                    ...
                    <div className="flex gap-3">
                        <a href="#" className="text-[#B01212] hover:text-[#4A4DFF] h-8 w-8 rounded-full flex justify-center items-center"><i className="fab fa-facebook"></i></a>
                        <a href="#" className="text-[#B01212] hover:text-[#4A4DFF] h-8 w-8 rounded-full flex justify-center items-center"><i className="fab fa-instagram"></i></a>
                        <a href="#" className="text-[#B01212] hover:text-[#4A4DFF] h-8 w-8 rounded-full flex justify-center items-center"><i className="fab fa-twitter"></i></a>
                        <a href="#" className="text-[#B01212] hover:text-[#4A4DFF] h-8 w-8 rounded-full flex justify-center items-center"><i className="fab fa-youtube"></i></a>
                    </div>
                </div>
